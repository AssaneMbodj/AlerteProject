...
{
    public class AffichageAlertesController : Controller
    {
        private readonly WebAppContext _context;

        public AffichageAlertesController(WebAppContext context)
        {
            _context = context;
        }

        // GET: AffichageAlertes
        [Authorize]
        ...
        // GET: AffichageAlertes/Details/5
        [Authorize]
        ...
        // POST: AffichageAlertes/Delete/5
